(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".services-page__slider")) new core(".services-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    function headerScroll() {
        ...
        const startPoint = header.dataset.scroll ? header.dataset.scroll : 850;
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                ...
                header.classList.contains("_header-remove") ? header.classList.remove("_header-remove") : null;
            } else {
                !header.classList.contains("_header-remove") ? header.classList.add("_header-remove") : null;
    ...
    da.init();
    const popupInput = document.querySelectorAll(".info-popup__input");
    function inputFocus(event) {
        event.target.closest("div").querySelector(".info-popup__input-placeholder").classList.add("_hidden");
    }
    function inputBlur(event) {
        if ("" != event.target.value) return;
        event.target.closest("div").querySelector(".info-popup__input-placeholder").classList.remove("_hidden");
    }
    popupInput.forEach((popupInput => {
        popupInput.addEventListener("focus", inputFocus);
    }));
    popupInput.forEach((popupInput => {
        popupInput.addEventListener("blur", inputBlur);
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
